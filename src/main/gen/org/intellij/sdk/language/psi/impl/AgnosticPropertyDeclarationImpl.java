...
public class AgnosticPropertyDeclarationImpl extends ASTWrapperPsiElement implements AgnosticPropertyDeclaration {

  public AgnosticPropertyDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }
