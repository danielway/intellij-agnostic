...
public class AgnosticPrefixExprImpl extends AgnosticExprImpl implements AgnosticPrefixExpr {

  public AgnosticPrefixExprImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public AgnosticPrefixOperator getPrefixOperator() {
    return findNotNullChildByClass(AgnosticPrefixOperator.class);
  }
