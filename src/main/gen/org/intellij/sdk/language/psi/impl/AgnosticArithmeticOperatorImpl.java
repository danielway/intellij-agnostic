...
public class AgnosticArithmeticOperatorImpl extends ASTWrapperPsiElement implements AgnosticArithmeticOperator {

  public AgnosticArithmeticOperatorImpl(@NotNull ASTNode node) {
    super(node);
  }
