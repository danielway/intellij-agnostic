...
public class AgnosticPrefixOperatorImpl extends ASTWrapperPsiElement implements AgnosticPrefixOperator {

  public AgnosticPrefixOperatorImpl(@NotNull ASTNode node) {
    super(node);
  }
