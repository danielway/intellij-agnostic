...
public class AgnosticConditionalOperatorImpl extends ASTWrapperPsiElement implements AgnosticConditionalOperator {

  public AgnosticConditionalOperatorImpl(@NotNull ASTNode node) {
    super(node);
  }
