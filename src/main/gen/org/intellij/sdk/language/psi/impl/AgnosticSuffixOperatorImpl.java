...
public class AgnosticSuffixOperatorImpl extends ASTWrapperPsiElement implements AgnosticSuffixOperator {

  public AgnosticSuffixOperatorImpl(@NotNull ASTNode node) {
    super(node);
  }
