...
public class AgnosticForTupleDeclarationImpl extends ASTWrapperPsiElement implements AgnosticForTupleDeclaration {

  public AgnosticForTupleDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AgnosticVisitor visitor) {
    visitor.visitForTupleDeclaration(this);
  }
