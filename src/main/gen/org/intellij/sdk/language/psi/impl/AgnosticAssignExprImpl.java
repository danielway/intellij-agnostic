...
public class AgnosticAssignExprImpl extends AgnosticExprImpl implements AgnosticAssignExpr {

  public AgnosticAssignExprImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public AgnosticAssignmentOperator getAssignmentOperator() {
    return findNotNullChildByClass(AgnosticAssignmentOperator.class);
  }
