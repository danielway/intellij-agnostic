...
public class AgnosticModuleDeclarationImpl extends ASTWrapperPsiElement implements AgnosticModuleDeclaration {

  public AgnosticModuleDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }
