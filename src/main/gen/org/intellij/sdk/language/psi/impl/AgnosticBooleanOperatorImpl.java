...
public class AgnosticBooleanOperatorImpl extends ASTWrapperPsiElement implements AgnosticBooleanOperator {

  public AgnosticBooleanOperatorImpl(@NotNull ASTNode node) {
    super(node);
  }
