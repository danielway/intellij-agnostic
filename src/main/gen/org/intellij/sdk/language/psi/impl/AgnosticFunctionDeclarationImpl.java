...
public class AgnosticFunctionDeclarationImpl extends ASTWrapperPsiElement implements AgnosticFunctionDeclaration {

  public AgnosticFunctionDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public AgnosticFunctionName getFunctionName() {
    return findNotNullChildByClass(AgnosticFunctionName.class);
  }
