...
public class AgnosticAssignmentOperatorImpl extends ASTWrapperPsiElement implements AgnosticAssignmentOperator {

  public AgnosticAssignmentOperatorImpl(@NotNull ASTNode node) {
    super(node);
  }
